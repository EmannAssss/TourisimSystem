              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    _buildFormField("User Name", Icons.person, TextInputType.text, validator: _validateField),
                    const SizedBox(height: 16),

                    _buildFormField("Email", Icons.email, TextInputType.emailAddress, validator: _validateEmail),
                    const SizedBox(height: 16),
